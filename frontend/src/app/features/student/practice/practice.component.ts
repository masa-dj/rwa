...
import { SessionService, Session, ExerciseType } from '../../../core/services/session.service';
...
export class PracticeComponent implements OnInit {
  ...
  private checkActiveThenLoad() {
    // anti-duplicate-tab guard, wired in from the start this time
  ...
  start() {
    this.sessionService.start(this.selectedExercise).subscribe((session) => {
